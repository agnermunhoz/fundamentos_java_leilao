...
public class TelaItem extends JDialog {
	...
	public TelaItem() {
		...
		panelLabels.add(new JLabel("Item do Leilão  "));
		panelLabels.add(new JLabel("Valor mínimo do Item  "));
		panelLabels.add(new JLabel("Duração do Leilão (min)  "));
